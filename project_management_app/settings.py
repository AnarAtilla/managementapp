...
import os
from datetime import timedelta  # Импортировать timedelta
...
# Укажите ID и секрет клиента
SOCIALACCOUNT_FACEBOOK_CLIENT_ID = 'YOUR_FACEBOOK_APP_ID'
SOCIALACCOUNT_FACEBOOK_SECRET = 'YOUR_FACEBOOK_APP_SECRET'

# Укажите ID и секрет клиента
SOCIALACCOUNT_GOOGLE_CLIENT_ID = 'YOUR_GOOGLE_CLIENT_ID'
SOCIALACCOUNT_GOOGLE_SECRET = 'YOUR_GOOGLE_SECRET'
